    ...
    class _Completions:
        ...
        def _fallback_content(prompt: str) -> str:
            if "Break this question into" in prompt:
                return json.dumps(["Search available records for the requested topic"])
            if "Extract a chronological timeline" in prompt:
                return json.dumps([{"date": "2024-01-01", "event_type": "discussion", "title": "Fallback timeline entry", "description": "This response was generated locally because the external AI service was unavailable.", "participants": [], "sentiment": "neutral", "is_critical": False, "doc_id": "LOCAL-001"}])
